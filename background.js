...
function addWordAjax(word,callback) {
    var lang='';
...
chrome.runtime.onMessage.addListener(function(message,sender,sendResponse){
    if(message.action=="addword"){
        ...
        //        "Referer":"http://dict.youdao.com/search?q="+message.data+"&tab=&keyfrom=dict.index&product=DICT&tp=urstoken&s=true",
        ...
        //        sendResponse({error:"error",item:{XHR:XHR,textStatus:textStatus,errorThrown:errorThrown}})
        //        return true;
        //    }});
        var xhr = new XMLHttpRequest();
        ...
        var url='http://dict.youdao.com/wordbook/ajax?action=addword&q='+encodeURIComponent(message.data)+'&date='+new Date()+'&le=eng';
        xhr.open('GET', url, true);
        xhr.send();
    }
    ...
    if(message.action=="openlogout"){
        ...
        //showLWindow("http://dict.youdao.com/")
    }
});
